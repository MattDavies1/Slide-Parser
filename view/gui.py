...
class GUI():
    ...
    def init_widgets(self):
        ...
        self.choose_input_loc_button = ttk.Button(self.mainframe, text="...", command=chooseInputFile)
        ...
        self.choose_output_loc_button = ttk.Button(self.mainframe, text="...", command=chooseOutputFolder)
        self.choose_output_loc_button.grid(column=6, row=3, sticky=(E,W))

        # parsing button widget
        self.preview_button = ttk.Button(self.mainframe, text="preview", command=startParsingImage)
        self.preview_button.grid(columnspan=3, column=1, row=4, sticky=(E,W))

        # preview button widget
        self.parse_button = ttk.Button(self.mainframe, text="parse", command=showPreviewParser)
